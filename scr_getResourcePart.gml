/// Search the resource tree for a resource name part and return its resource id

// argument0 - string - resource name part to find
...
for(i=0; sprite_exists(i); i++) {
    if (string_pos(argument0, sprite_get_name(i))) {
        return i;
    }
}
...
for(i=0; sound_exists(i); i++) {
    if (string_pos(argument0, sound_get_name(i))) {
        return i;
    }
}
...
for(i=0; background_exists(i); i++) {
    if (string_pos(argument0, background_get_name(i))) {
        return i;
    }
}
...
for(i=0; path_exists(i); i++) {
    if (string_pos(argument0, path_get_name(i))) {
        return i;
    }
}
...
for(i=0; font_exists(i); i++) {
    if (string_pos(argument0, font_get_name(i))) {
        return i;
    }
}
...
for(i=0; object_exists(i); i++) {
    if (string_pos(argument0, object_get_name(i))) {
        return i;
    }
}
...
for(i=0; room_exists(i); i++) {
    if (string_pos(argument0, room_get_name(i))) {
        return i;
    }
}
